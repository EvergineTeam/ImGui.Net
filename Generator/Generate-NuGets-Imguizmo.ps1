...
param (
	...
	[string]$imguizmoBindingsCsprojPath = "Evergine.Bindings.Imguizmo\Evergine.Bindings.Imguizmo.csproj"
)
...
& dotnet pack "$imguizmoBindingsCsprojPath" -v:$buildVerbosity -p:Configuration=$buildConfiguration -p:PackageOutputPath="$absoluteOutputFolder" -p:IncludeSymbols=true -p:Version=$version
