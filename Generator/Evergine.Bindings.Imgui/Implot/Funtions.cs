...
namespace Evergine.Bindings.Implot
{
	public static unsafe partial class ImplotNative
	{
		...
		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotBarGroups_FloatPtr([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, float* values, int item_count, int group_count, double group_size, double shift, ImPlotBarGroupsFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotBarGroups_doublePtr([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, double* values, int item_count, int group_count, double group_size, double shift, ImPlotBarGroupsFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotBarGroups_S8Ptr([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, sbyte* values, int item_count, int group_count, double group_size, double shift, ImPlotBarGroupsFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotBarGroups_U8Ptr([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, byte* values, int item_count, int group_count, double group_size, double shift, ImPlotBarGroupsFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotBarGroups_S16Ptr([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, short* values, int item_count, int group_count, double group_size, double shift, ImPlotBarGroupsFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotBarGroups_U16Ptr([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, ushort* values, int item_count, int group_count, double group_size, double shift, ImPlotBarGroupsFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotBarGroups_S32Ptr([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, int* values, int item_count, int group_count, double group_size, double shift, ImPlotBarGroupsFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotBarGroups_U32Ptr([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, uint* values, int item_count, int group_count, double group_size, double shift, ImPlotBarGroupsFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotBarGroups_S64Ptr([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, long* values, int item_count, int group_count, double group_size, double shift, ImPlotBarGroupsFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotBarGroups_U64Ptr([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, ulong* values, int item_count, int group_count, double group_size, double shift, ImPlotBarGroupsFlags flags);
		...
		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotPieChart_FloatPtrPlotFormatter([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, float* values, int count, double x, double y, double radius, void* fmt, void* fmt_data, double angle0, ImPlotPieChartFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotPieChart_doublePtrPlotFormatter([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, double* values, int count, double x, double y, double radius, void* fmt, void* fmt_data, double angle0, ImPlotPieChartFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotPieChart_S8PtrPlotFormatter([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, sbyte* values, int count, double x, double y, double radius, void* fmt, void* fmt_data, double angle0, ImPlotPieChartFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotPieChart_U8PtrPlotFormatter([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, byte* values, int count, double x, double y, double radius, void* fmt, void* fmt_data, double angle0, ImPlotPieChartFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotPieChart_S16PtrPlotFormatter([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, short* values, int count, double x, double y, double radius, void* fmt, void* fmt_data, double angle0, ImPlotPieChartFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotPieChart_U16PtrPlotFormatter([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, ushort* values, int count, double x, double y, double radius, void* fmt, void* fmt_data, double angle0, ImPlotPieChartFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotPieChart_S32PtrPlotFormatter([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, int* values, int count, double x, double y, double radius, void* fmt, void* fmt_data, double angle0, ImPlotPieChartFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotPieChart_U32PtrPlotFormatter([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, uint* values, int count, double x, double y, double radius, void* fmt, void* fmt_data, double angle0, ImPlotPieChartFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotPieChart_S64PtrPlotFormatter([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, long* values, int count, double x, double y, double radius, void* fmt, void* fmt_data, double angle0, ImPlotPieChartFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotPieChart_U64PtrPlotFormatter([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, ulong* values, int count, double x, double y, double radius, void* fmt, void* fmt_data, double angle0, ImPlotPieChartFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotPieChart_FloatPtrStr([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, float* values, int count, double x, double y, double radius, [MarshalAs(UnmanagedType.LPUTF8Str)] string label_fmt, double angle0, ImPlotPieChartFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotPieChart_doublePtrStr([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, double* values, int count, double x, double y, double radius, [MarshalAs(UnmanagedType.LPUTF8Str)] string label_fmt, double angle0, ImPlotPieChartFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotPieChart_S8PtrStr([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, sbyte* values, int count, double x, double y, double radius, [MarshalAs(UnmanagedType.LPUTF8Str)] string label_fmt, double angle0, ImPlotPieChartFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotPieChart_U8PtrStr([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, byte* values, int count, double x, double y, double radius, [MarshalAs(UnmanagedType.LPUTF8Str)] string label_fmt, double angle0, ImPlotPieChartFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotPieChart_S16PtrStr([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, short* values, int count, double x, double y, double radius, [MarshalAs(UnmanagedType.LPUTF8Str)] string label_fmt, double angle0, ImPlotPieChartFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotPieChart_U16PtrStr([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, ushort* values, int count, double x, double y, double radius, [MarshalAs(UnmanagedType.LPUTF8Str)] string label_fmt, double angle0, ImPlotPieChartFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotPieChart_S32PtrStr([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, int* values, int count, double x, double y, double radius, [MarshalAs(UnmanagedType.LPUTF8Str)] string label_fmt, double angle0, ImPlotPieChartFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotPieChart_U32PtrStr([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, uint* values, int count, double x, double y, double radius, [MarshalAs(UnmanagedType.LPUTF8Str)] string label_fmt, double angle0, ImPlotPieChartFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotPieChart_S64PtrStr([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, long* values, int count, double x, double y, double radius, [MarshalAs(UnmanagedType.LPUTF8Str)] string label_fmt, double angle0, ImPlotPieChartFlags flags);

		[DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotPieChart_U64PtrStr([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringArrayMarshaler))] string[] label_ids, ulong* values, int count, double x, double y, double radius, [MarshalAs(UnmanagedType.LPUTF8Str)] string label_fmt, double angle0, ImPlotPieChartFlags flags);
