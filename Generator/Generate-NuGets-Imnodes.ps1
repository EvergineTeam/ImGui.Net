...
param (
	...
	[string]$imnodesBindingsCsprojPath = "Evergine.Bindings.Imnodes\Evergine.Bindings.Imnodes.csproj"
)
...
& dotnet pack "$imnodesBindingsCsprojPath" -v:$buildVerbosity -p:Configuration=$buildConfiguration -p:PackageOutputPath="$absoluteOutputFolder" -p:IncludeSymbols=true -p:Version=$version
