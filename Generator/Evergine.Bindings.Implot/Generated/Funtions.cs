...
namespace Evergine.Bindings.Implot
{
	public static unsafe partial class ImplotNative
	{
		...
		[DllImport("cimplot", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotBarsG(byte* label_id, ImPlotPoint* getter, void* data, int count, double bar_width);
		...
		[DllImport("cimplot", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotBarsHG(byte* label_id, ImPlotPoint* getter, void* data, int count, double bar_height);
		...
		[DllImport("cimplot", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotDigitalG(byte* label_id, ImPlotPoint* getter, void* data, int count);
		...
		[DllImport("cimplot", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotLineG(byte* label_id, ImPlotPoint* getter, void* data, int count);
		...
		[DllImport("cimplot", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotScatterG(byte* label_id, ImPlotPoint* getter, void* data, int count);
		...
		[DllImport("cimplot", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotShadedG(byte* label_id, ImPlotPoint* getter1, void* data1, ImPlotPoint* getter2, void* data2, int count);
		...
		[DllImport("cimplot", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ImPlot_PlotStairsG(byte* label_id, ImPlotPoint* getter, void* data, int count);
